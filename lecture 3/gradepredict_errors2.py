...
#test 3: testing for error in calculate_midterm_score
midterms=[100,100]
expected_midterm_output= 100 * 2
midterms2= [50,60]
expected_midterm_output2= 50+60
if calculate_midterm_score(midterms)== expected_midterm_output:
    print('pass 4')
else:
    print('fail 4')
if calculate_midterm_score(midterms2)== expected_midterm_output2:
    print('pass 5')
else:
    print('fail 5')
#test 4: testing for errors in project scores
projects=[200,200,200]
expected_project_output= 200 * 3
projects2= [150,160,180]
expected_project_output2= 150+160+180
if calculate_project_score(projects)== expected_project_output:
    print('pass 6')
else:
    print('fail 6')
if calculate_project_score(projects2)== expected_project_output2:
    print('pass 7')
else:
    print('fail 7')
