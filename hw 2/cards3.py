...
class test_hand(unittest.TestCase):
	...
	def test_pairs(self):
		h = Hand([Card(1,2), Card(2,6), Card(0,6), Card(1,6)])
		h.remove_pairs()
...
class test_deck(unittest.TestCase):
	def test_deal(self):
		deck=Deck()
		list_hands=deck.deal(4,5)
		self.assertEqual(4,len(list_hands))
		self.assertEqual(32,len(deck.cards))
		self.assertEqual(len(list_hands[0].cards),5)
	def test_deal2(self):
		deck=Deck()
		list_hands=deck.deal(4,-1)
		self.assertEqual(4,len(list_hands))
		self.assertEqual(0,len(deck.cards))
		self.assertEqual(len(list_hands[0].cards),13)
